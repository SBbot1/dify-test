const translation = {
  ...
  contribute: {
    ...
    line2: "створення інструментів для Superbot.",
  ...
  auth: {
    ...
    setupModalTitleDescription:
      "Після налаштування облікових даних усі члени робочого простору можуть використовувати цей інструмент під час оркестрування програм.",
  },
  ...
  createTool: {
    ...
    authMethod: {
      ...
      keyTooltip:
        'Ключ HTTP-заголовка. Якщо ви не знаєте, залиште його як "Authorization" або встановіть власне значення',
      types: {
        none: "Відсутня",
        api_key: "API-ключ",
  ...
  noCustomTool: {
    ...
    content:
      "Додавайте та керуйте своїми власними інструментами тут для створення програм зі штучним інтелектом.",
    createTool: "Створити інструмент",
  },
  noSearchRes: {
    title: "Вибачте, немає результатів!",
    content:
      "Ми не знайшли жодних інструментів, які б відповідали вашому пошуку.",
    reset: "Скинути пошук",
  },
