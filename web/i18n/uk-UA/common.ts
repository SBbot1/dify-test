const translation = {
  ...
  account: {
    ...
    langGeniusAccount: "Обліковий запис Superbot",
    langGeniusAccountTip:
      "Ваш обліковий записSuperBotта пов’язані з ним дані користувача.",
  ...
  members: {
    ...
    invitationSentTip:
      "Запрошення надіслано, і вони можуть увійти в Superbot, щоб отримати доступ до даних вашої команди.",
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: "Служба хостингу OpenAI, надана Superbot, дозволяє використовувати такі моделі, як GPT-3.5. Перш ніж ваша пробна квота буде використана, вам потрібно налаштувати інші постачальники моделі.",
  ...
  apiBasedExtension: {
    title:
      "API-розширення забезпечують централізоване керування API, спрощуючи конфігурацію для зручного використання в різних програмах Superbot.",
  ...
  about: {
    ...
    nowAvailable: "Superbot {{version}} тепер доступна.",
    latestAvailable: "Superbot {{version}} – це найновіша доступна версія.",
  },
  appMenus: {
    overview: "Огляд",
