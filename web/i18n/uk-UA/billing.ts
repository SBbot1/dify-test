const translation = {
  ...
  buyPermissionDeniedTip:
    "Зв'яжіться з адміністратором вашого підприємства, щоб оформити підписку",
  plansCommon: {
    ...
    vectorSpaceBillingTooltip:
      "Кожен 1 МБ може зберігати близько 1,2 мільйона символів векторизованих даних (оцінка з використанням OpenAI Embeddings, відрізняється в залежності від моделей).",
    vectorSpaceTooltip:
      "Векторний простір – це система довгострокової пам'яті, необхідна LLM для розуміння ваших даних.",
    documentProcessingPriority: "Пріоритет обробки документів",
    documentProcessingPriorityTip:
      "Для вищого пріоритету обробки документів оновіть свій план.",
    documentProcessingPriorityUpgrade:
      "Обробляйте більше даних із вищою точністю та на більших швидкостях.",
    priority: {
    ...
    messageRequest: {
      ...
      tooltip:
        "Квоти на виклик повідомлень для різних планів з використанням моделей OpenAI (крім gpt4). Повідомлення понад ліміт використовуватимуть ваш ключ API OpenAI.",
    },
    annotatedResponse: {
      title: "Ліміти квоти відповідей з анотаціями",
      tooltip:
        "Ручне редагування та анотування відповідей забезпечує налаштовувані високоякісні можливості відповідей на запитання для програм. (Застосовується лише в чат-програмах)",
    },
    ragAPIRequestTooltip:
      "Відноситься до кількості викликів API, що викликають лише можливості обробки бази знань Superbot.",
    receiptInfo:
      "Лише власник команди та адміністратор команди можуть підписуватися та переглядати інформацію про виставлення рахунків",
  },
  plans: {
    sandbox: {
      name: "Пісочниця",
    ...
    professional: {
      name: "Професійний",
      description:
        "Щоб окремі особи та невеликі команди могли отримати більше можливостей за доступною ціною.",
      includesTitle: "Все у безкоштовному плані, плюс:",
    },
    team: {
      name: "Команда",
      description:
        "Співпрацюйте без обмежень і користуйтеся продуктивністю найвищого рівня.",
      includesTitle: "Все, що входить до плану Professional, плюс:",
    },
    enterprise: {
      name: "Ентерпрайз",
      description:
        "Отримайте повні можливості та підтримку для масштабних критично важливих систем.",
