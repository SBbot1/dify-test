const translation = {
  ...
  welcome: "Ласкаво просимо до Superbot, будь ласка, увійдіть, щоб продовжити.",
  ...
  license: {
    tip: "Перед запускомSuperBotCommunity Edition ознайомтеся з ліцензією з відкритим кодом на GitHub",
    link: "Ліцензія з відкритим кодом",
  },
  join: "Приєднуйтесь",
  joinTipStart: "Запрошуємо вас приєднатися",
  joinTipEnd: "команда Superbot",
  invalid: "Посилання застаріло",
  explore: "Досліджуйте Superbot",
