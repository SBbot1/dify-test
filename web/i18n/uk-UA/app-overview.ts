const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: "Або спробуйте хмарну версіюSuperBotз безкоштовним цитатою",
  },
  overview: {
    title: "Огляд",
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            "Допомагає відвідувачам зрозуміти дані, зібрані додатком, див. <privacyPolicyLink>Політику конфіденційності</privacyPolicyLink> Superbot.",
      ...
      embedded: {
        ...
        chromePlugin: "Встановити розширення ChromeSuperBotChatbot",
        copied: "Скопійовано",
        copy: "Скопіювати",
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: "Клієнт-Web-Superbot",
  ...
  analysis: {
    ...
    totalMessages: {
      ...
      explanation:
        "Щоденна кількість взаємодій з штучним інтелектом; інженерія/налагодження запитів виключено.",
    },
    activeUsers: {
