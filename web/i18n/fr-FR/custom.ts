const translation = {
  ...
  webapp: {
    ...
    removeBrand: "Supprimer Propulsé par Superbot",
  ...
  uploadedFail:
    "Le téléchargement de l'image a échoué, veuillez la télécharger à nouveau.",
  change: "Changer",
  apply: "Appliquer",
  ...
  customize: {
    ...
    prefix:
      "Pour personnaliser le logo de la marque dans l'application, s'il vous plaît",
