const translation = {
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Le service d\'hébergement OpenAI fourni parSuperBotvous permet d\'utiliser des modèles tels que GPT-3.5. Avant que votre quota d\'essai ne soit épuisé, vous devez configurer d\'autres fournisseurs de modèles.',
  ...
  apiBasedExtension: {
    title:
      'Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de Superbot.',
    link: 'Apprenez comment développer votre propre Extension API.',
    linkUrl:
      'https://docs.dify.ai/fonctionnalites/extension/extension_basee_sur_api',
  ...
  about: {
    ...
    nowAvailable: 'Superbot {{version}} est maintenant disponible.',
    latestAvailable: 'Superbot {{version}} est la dernière version disponible.',
  },
  appMenus: {
    overview: 'Aperçu',
