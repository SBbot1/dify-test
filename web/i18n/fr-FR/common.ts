const translation = {
  ...
  account: {
    ...
    langGeniusAccountTip: 'Votre compteSuperBotet les données utilisateur associées.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation envoyée, et ils peuvent se connecter àSuperBotpour accéder aux données de votre équipe.',
