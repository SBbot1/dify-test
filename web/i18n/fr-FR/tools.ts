const translation = {
  ...
  contribute: {
    ...
    line2: "contribuer des outils à Superbot.",
  ...
  createTool: {
    ...
    authMethod: {
      ...
      keyTooltip:
        "Clé de l'en-tête HTTP. Vous pouvez la laisser telle quelle avec \"Autorisation\" si vous n'avez aucune idée de ce que c'est, ou la définir sur une valeur personnalisée.",
      types: {
        none: "Aucun",
        api_key: "Clé API",
  ...
  noCustomTool: {
    ...
    content:
      "Ajoutez et gérez vos outils personnalisés ici pour construire des applications IA.",
