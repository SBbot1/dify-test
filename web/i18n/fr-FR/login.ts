const translation = {
  ...
  welcome: "Bienvenue sur Superbot, veuillez vous connecter pour continuer.",
  ...
  license: {
    tip: "Avant de commencerSuperBotCommunity Edition, lisez le GitHub",
    link: "Licence Open-source",
  },
  join: "Rejoindre",
  joinTipStart: "Je vous invite à rejoindre",
  joinTipEnd: "équipe sur Superbot",
  invalid: "Le lien a expiré",
  explore: "Explorez Superbot",
