const translation = {
  ...
  apiKeyInfo: {
    ...
    usedToken: "使用 Tokens",
    setAPIBtn: "設定模型提供商",
    tryCloud: "或者嘗試使用SuperBot的雲版本並使用試用配額",
  },
  overview: {
    title: "概覽",
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            "幫助訪問者瞭解該應用收集的資料，可參考 Superbot 的<privacyPolicyLink>隱私政策</privacyPolicyLink>。",
      ...
      embedded: {
        ...
        chromePlugin: "安裝SuperBotChrome 瀏覽器擴充套件",
        copied: "已複製",
        copy: "複製",
      },
      qrcode: {
  ...
  analysis: {
    ...
    activeUsers: {
      title: "活躍使用者數",
      explanation:
        "與 AI 有效互動，即有一問一答以上的唯一使用者數。提示詞編排和除錯的會話不計入。",
    },
    tokenUsage: {
      title: "費用消耗",
    ...
    avgSessionInteractions: {
      title: "平均會話互動數",
      explanation:
        "反應每個會話使用者的持續溝通次數，如果使用者與 AI 問答了 10 輪，即為 10。該指標反映了使用者粘性。僅在對話型應用提供。",
    },
    avgUserInteractions: {
      title: "平均使用者呼叫次數",
