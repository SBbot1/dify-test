const translation = {
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: "Der OpenAI-Hostingdienst vonSuperBotermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.",
  ...
  apiBasedExtension: {
    title:
      "API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in Superbots Anwendungen.",
  ...
  about: {
    ...
    nowAvailable: "Superbot {{version}} ist jetzt verfügbar.",
    latestAvailable: "Superbot {{version}} ist die neueste verfügbare Version.",
  },
  appMenus: {
    overview: "Übersicht",
