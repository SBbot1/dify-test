const translation = {
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: "O serviço de hospedagem OpenAI fornecido pelaSuperBotpermite que você use modelos como GPT-3.5. Antes que sua cota de teste seja esgotada, você precisa configurar outros fornecedores de modelos.",
      callTimes: "Chamadas",
      usedUp:
  ...
  apiBasedExtension: {
    title:
      "As extensões de API fornecem gerenciamento centralizado de API, simplificando a configuração para uso fácil em todos os aplicativos da Superbot.",
  ...
  about: {
    ...
    nowAvailable: "Superbot {{version}} já está disponível.",
    latestAvailable: "Superbot {{version}} é a última versão disponível.",
  },
  appMenus: {
