const translation = {
  ...
  contribute: {
    ...
    line2: "contribuir com ferramentas para o Superbot.",
  ...
  auth: {
    ...
    setupModalTitleDescription:
      "Após configurar as credenciais, todos os membros do espaço de trabalho podem usar essa ferramenta ao orquestrar aplicativos.",
  },
  ...
  createTool: {
    ...
    authMethod: {
      ...
      keyTooltip:
        'Chave do Cabeçalho HTTP, você pode deixar como "Authorization" se não tiver ideia do que é ou definir um valor personalizado',
      types: {
        none: "Nenhum",
  ...
  noCustomTool: {
    ...
    content:
      "Adicione e gerencie suas ferramentas personalizadas aqui para construir aplicativos de IA.",
    createTool: "Criar Ferramenta",
  },
  noSearchRes: {
    title: "Desculpe, sem resultados!",
    content:
      "Não encontramos nenhuma ferramenta que corresponda à sua pesquisa.",
