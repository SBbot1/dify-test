const translation = {
  ...
  welcome: "Bem-vindo ao Superbot, faça login para continuar.",
  ...
  license: {
    tip: "Antes de começar a usar a Edição Comunitária do Superbot, leia a",
    link: "Licença de código aberto do GitHub",
  },
  join: "Participar",
  joinTipStart: "Convidamos você a participar da",
  joinTipEnd: "equipe no Superbot",
  invalid: "O link expirou",
  explore: "Explorar o Superbot",
