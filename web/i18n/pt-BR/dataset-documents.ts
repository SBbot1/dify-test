const translation = {
  list: {
    title: 'Documentos',
    desc: 'Todos os arquivos do Knowledge são mostrados aqui, e todo o Knowledge pode ser vinculado a citações doSuperBotou indexado por meio do plugin Chat.',
    ...
    empty: {
      ...
      sync: {
        tip: 'OSuperBotbaixará periodicamente arquivos do seu Notion e concluirá o processamento.',
      },
    },
    delete: {
