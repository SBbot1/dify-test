const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip:
      "Refers to the number of API calls invoking only the knowledge base processing capabilities of Superbot.",
    receiptInfo:
      "Somente proprietários e administradores de equipe podem se inscrever e visualizar informações de cobrança",
  },
  plans: {
    sandbox: {
      name: "Sandbox",
