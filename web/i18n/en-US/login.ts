const translation = {
  ...
  welcome: 'Welcome to Superbot, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before startingSuperBotCommunity Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Superbot',
  invalid: 'The link has expired',
  explore: 'Explore Superbot',
