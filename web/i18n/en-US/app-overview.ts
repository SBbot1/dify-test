const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: "Or try the cloud version ofSuperBotwith free quote",
  },
  overview: {
    title: "Overview",
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            "Helps visitors understand the data the application collects, see Superbot's <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.",
      ...
      embedded: {
        ...
        chromePlugin: "InstallSuperBotChatbot Chrome Extension",
        copied: "Copied",
        copy: "Copy",
      },
      qrcode: {
