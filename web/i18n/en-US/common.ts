const translation = {
  ...
  account: {
    ...
    langGeniusAccount: "Superbot account",
    langGeniusAccountTip: "YourSuperBotaccount and associated user data.",
    editName: "Edit Name",
  ...
  members: {
    ...
    invitationSentTip:
      "Invitation sent, and they can sign in toSuperBotto access your team data.",
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: "The OpenAI hosting service provided bySuperBotallows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.",
  ...
  apiBasedExtension: {
    title:
      "API extensions provide centralized API management, simplifying configuration for easy use across Superbot's applications.",
  ...
  about: {
    ...
    nowAvailable: "Superbot {{version}} is now available.",
    latestAvailable: "Superbot {{version}} is the latest version available.",
  },
  appMenus: {
    overview: "Overview",
