const translation = {
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: "Serviciul de găzduire OpenAI furnizat deSuperBotvă permite să utilizați modele precum GPT-3.5. Înainte ca cota de probă să fie epuizată, trebuie să configurați alți furnizori de modele.",
      callTimes: "Apeluri",
      usedUp:
  ...
  apiBasedExtension: {
    title:
      "Extensiile bazate pe API oferă o gestionare centralizată a API-urilor, simplificând configurația pentru o utilizare ușoară în aplicațiile Superbot.",
  ...
  about: {
    ...
    nowAvailable: "Superbot {{version}} este acum disponibil.",
    latestAvailable: "Superbot {{version}} este ultima versiune disponibilă.",
  },
  appMenus: {
