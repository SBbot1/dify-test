const translation = {
  ...
  buyPermissionDeniedTip:
    "Vă rugăm să contactați administratorul dvs. de întreprindere pentru a vă abona",
  plansCommon: {
    ...
    vectorSpaceBillingTooltip:
      "Fiecare 1MB poate stoca aproximativ 1,2 milioane de caractere de date vectorizate (estimat folosind OpenAI Embeddings, variază în funcție de modele).",
    vectorSpaceTooltip:
      "Spațiul vectorial este sistemul de memorie pe termen lung necesar pentru ca LLM-urile să înțeleagă datele dvs.",
    ...
    documentProcessingPriorityTip:
      "Pentru o prioritate mai mare a procesării documentelor, vă rugăm să actualizați planul.",
    documentProcessingPriorityUpgrade:
      "Procesați mai multe date cu o acuratețe mai mare și la viteze mai rapide.",
    priority: {
      standard: "Standard",
      priority: "Prioritate",
    ...
    messageRequest: {
      ...
      tooltip:
        "Cote de invocare a mesajelor pentru diferite planuri utilizând modele OpenAI (cu excepția gpt4). Mesajele peste limită vor utiliza cheia API OpenAI.",
    },
    annotatedResponse: {
      title: "Limite de cotă de anotare",
      tooltip:
        "Editarea și anotarea manuală a răspunsurilor oferă capacități de întrebări și răspunsuri personalizabile și de înaltă calitate pentru aplicații. (Aplicabil numai în aplicațiile de chat)",
    },
    ragAPIRequestTooltip:
      "Se referă la numărul de apeluri API care invocă doar capacitățile de procesare a bazei de cunoștințe a Superbot.",
    receiptInfo:
      "Doar proprietarul echipei și administratorul echipei pot să se aboneze și să vizualizeze informațiile de facturare",
  },
  plans: {
    sandbox: {
      name: "Sandbox",
    ...
    professional: {
      name: "Professional",
      description:
        "Pentru persoane fizice și echipe mici pentru a debloca mai multă putere la un preț accesibil.",
      includesTitle: "Tot ce este în planul gratuit, plus:",
    },
    team: {
      name: "Echipă",
      description:
        "Colaborați fără limite și bucurați-vă de performanțe de top.",
      includesTitle: "Tot ce este în planul Professional, plus:",
    },
    enterprise: {
      name: "Întreprindere",
      description:
        "Obțineți capacități și asistență complete pentru sisteme critice la scară largă.",
