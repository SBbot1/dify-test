const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: "Lub wypróbuj wersję chmurowąSuperBotz darmowym limitem",
  },
  overview: {
    title: "Przegląd",
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            "Pomaga odwiedzającym zrozumieć, jakie dane zbiera aplikacja, zobacz <privacyPolicyLink>Politykę prywatności Superbot</privacyPolicyLink>.",
      ...
      embedded: {
        ...
        chromePlugin: "Zainstaluj rozszerzenie ChromeSuperBotChatbot",
        copied: "Skopiowane",
        copy: "Kopiuj",
      },
      qrcode: {
