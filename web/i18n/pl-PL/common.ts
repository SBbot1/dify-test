const translation = {
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: "Usługa hostowania OpenAI dostarczana przezSuperBotpozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.",
  ...
  apiBasedExtension: {
    title:
      "Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Superbot.",
  ...
  about: {
    ...
    nowAvailable: "Superbot {{version}} jest teraz dostępny.",
    latestAvailable: "Superbot {{version}} jest najnowszą dostępną wersją.",
  },
  appMenus: {
    overview: "Przegląd",
