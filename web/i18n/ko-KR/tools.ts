const translation = {
  ...
  auth: {
    ...
    setupModalTitleDescription:
      "자격 증명을 구성한 후에 워크스페이스의 모든 멤버가 이 도구를 사용하여 애플리케이션을 조작할 수 있습니다.",
  },
  ...
  createTool: {
    ...
    nameForToolCallPlaceHolder:
      "getCurrentWeather, list_pets 과 같이, 기계 인지를 위해 사용됩니다.",
    nameForToolCallTip: "숫자와 문자, 밑줄만 지원합니다.",
    description: "설명",
    descriptionPlaceholder:
      "도구의 목적을 설명합니다. 예시로, 특정 지역의 온도 가져오기",
    schema: "스키마",
    ...
    authMethod: {
      ...
      type: "인증 유형",
      keyTooltip:
        'HTTP 헤더 키입니다. 생각이 없으면 "Authorization"으로 남겨둘 수 있습니다. 또는 사용자 정의 값을 설정할 수 있습니다.',
      types: {
        none: "없음",
        api_key: "API 키",
