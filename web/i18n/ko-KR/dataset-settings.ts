const translation = {
  ...
  form: {
    ...
    desc: "지식 설명",
    descInfo:
      "지식 내용을 개괄하는 명확한 텍스트 설명을 작성하세요. 이 설명은 여러 지식 중에서 선택하는 기준으로 사용됩니다.",
    descPlaceholder:
      "이 지식에 포함된 내용을 설명하세요. 자세한 설명은 AI가 지식 내용에 빠르게 접근할 수 있도록 합니다. 비어 있으면 Superbot가 기본 검색 전략을 사용합니다.",
    ...
    indexMethodHighQualityTip:
      "사용자 쿼리 시 더 높은 정확도를 제공하기 위해 OpenAI의 임베딩 인터페이스를 호출하여 처리합니다.",
    indexMethodEconomy: "경제적",
    indexMethodEconomyTip:
      "오프라인 벡터 엔진, 키워드 인덱스 등을 사용하여 토큰을 소비하지 않고도 정확도를 감소시킵니다.",
    ...
    retrievalSetting: {
      ...
      longDescription:
        " 검색 방법에 대한 자세한 내용은 언제든지 지식 설정에서 변경할 수 있습니다.",
    },
    save: "저장",
  },
};
