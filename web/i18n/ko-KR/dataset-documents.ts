const translation = {
  list: {
    title: "문서",
    desc: "지식의 모든 파일이 여기에 표시되며, 전체 지식이 Superbot의 인용문이나 챗 플러그인을 통해 링크되거나 색인화될 수 있습니다.",
    addFile: "파일 추가",
    addPages: "페이지 추가",
    table: {
      header: {
    ...
    empty: {
      ...
      sync: {
        tip: "Superbot는 정기적으로 Notion에서 파일을 다운로드하고 처리합니다.",
      },
    },
    delete: {
      title: "정말 삭제하시겠습니까?",
  ...
  metadata: {
    ...
    docTypeSelectWarning:
      "문서 유형을 변경하면 현재 입력된 메타데이터가 유지되지 않습니다.",
