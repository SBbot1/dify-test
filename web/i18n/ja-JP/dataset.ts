const translation = {
  ...
  didYouKnow: "ご存知ですか？",
  intro1: "知識はSuperbotアプリケーションに統合することができます",
  intro2: "コンテキストとして",
  intro3: "、",
  intro4: "または",
  intro5: "作成することができます",
  ...
  unavailable: "利用不可",
  unavailableTip:
    "埋め込みモデルが利用できません。デフォルトの埋め込みモデルを設定する必要があります",
  datasets: "知識",
  datasetsApi: "API",
  retrieval: {
    semantic_search: {
    ...
    hybrid_search: {
      title: "ハイブリッド検索",
      description:
        "全文検索とベクトル検索を同時に実行し、ユーザーのクエリに最適なマッチを選択するために再ランク付けを行います。再ランクモデルAPIの設定が必要です。",
      recommend: "おすすめ",
    },
    invertedIndex: {
      title: "逆インデックス",
