const translation = {
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: "Superbotが提供するOpenAIホスティングサービスを使用すると、GPT-3.5などのモデルを使用できます。トライアルクォータが使い果たされる前に、他のモデルプロバイダを設定する必要があります。",
      callTimes: "通話回数",
      usedUp:
  ...
  apiBasedExtension: {
    title:
      "API拡張機能は、Superbotのアプリケーション全体での簡単な使用のための設定を簡素化し、集中的なAPI管理を提供します。",
  ...
  about: {
    changeLog: "変更ログ",
    updateNow: "今すぐ更新",
    nowAvailable: "Superbot {{version}} が利用可能です。",
    latestAvailable: "Superbot {{version}} が最新バージョンです。",
  },
  appMenus: {
    overview: "概要",
  ...
  datasetMenus: {
    ...
    settings: "設定",
    emptyTip:
      "関連付けられた知識がありません。アプリケーションやプラグインに移動して関連付けを完了してください。",
    viewDoc: "ドキュメントを表示",
    relatedApp: "関連アプリ",
  },
  voiceInput: {
