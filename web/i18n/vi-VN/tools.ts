const translation = {
  ...
  contribute: {
    ...
    line2: "đóng góp công cụ cho Superbot.",
  ...
  auth: {
    ...
    setupModalTitleDescription:
      "Sau khi cấu hình thông tin đăng nhập, tất cả các thành viên trong không gian làm việc có thể sử dụng công cụ này khi triển khai ứng dụng.",
  },
  ...
  createTool: {
    ...
    authMethod: {
      ...
      type: "Loại xác thực",
      keyTooltip:
        "Khóa Tiêu đề HTTP, Bạn có thể để trống nếu không biết là gì hoặc đặt nó thành một giá trị tùy chỉnh",
      types: {
        none: "Không",
        api_key: "Khóa API",
  ...
  noCustomTool: {
    ...
    content:
      "Thêm và quản lý các công cụ tùy chỉnh của bạn ở đây để xây dựng ứng dụng AI.",
