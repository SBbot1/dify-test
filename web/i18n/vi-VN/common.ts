const translation = {
  ...
  account: {
    ...
    langGeniusAccountTip: 'Tài khoảnSuperBotcủa bạn và dữ liệu người dùng liên quan.',
  ...
  members: {
    ...
    invitationSentTip: 'Lời mời đã được gửi, và họ có thể đăng nhập vàoSuperBotđể truy cập vào dữ liệu nhóm của bạn.',
