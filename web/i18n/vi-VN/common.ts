const translation = {
  ...
  menus: {
    ...
    datasets: 'Kiến thức',
    datasetsTips:
      'SẮP RA MẮT: Nhập dữ liệu văn bản của bạn hoặc viết dữ liệu theo thời gian thực thông qua Webhook để cải thiện ngữ cảnh LLM.',
    newApp: 'Ứng dụng mới',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      exhausted: 'HẾT QUOTA',
      desc: 'Dịch vụ lưu trữ OpenAI được cung cấp bởiSuperBotcho phép bạn sử dụng các mô hình như GPT-3.5. Trước khi hết lượng truy vấn dùng thử, bạn cần thiết lập các nhà cung cấp mô hình khác.',
  ...
  apiBasedExtension: {
    title:
      'Các tiện ích API cung cấp quản lý API tập trung, giúp cấu hình dễ dàng sử dụng trên các ứng dụng của Superbot.',
  ...
  about: {
    ...
    nowAvailable: 'Superbot {{version}} hiện đã có sẵn.',
    latestAvailable: 'Superbot {{version}} là phiên bản mới nhất hiện có.',
  },
  appMenus: {
    overview: 'Tổng quan',
