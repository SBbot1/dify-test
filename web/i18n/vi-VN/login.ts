const translation = {
  ...
  welcome: "Chào mừng bạn đến với Superbot, vui lòng đăng nhập để tiếp tục.",
  email: "Địa chỉ Email",
  ...
  setAdminAccountDesc:
    "Quyền tối đa cho tài khoản quản trị, có thể được sử dụng để tạo ứng dụng và quản lý các nhà cung cấp LLM, v.v.",
  ...
  go: "Đi đến Superbot",
  sendUsMail:
    "Gửi email giới thiệu của bạn cho chúng tôi, và chúng tôi sẽ xử lý yêu cầu mời.",
  ...
  rightDesc:
    "Dễ dàng xây dựng ứng dụng AI hấp dẫn mắt, có thể vận hành và cải thiện được.",
  ...
  license: {
    tip: "Trước khi bắt đầu Phiên bản Cộng đồng của Superbot, hãy đọc",
    link: "Giấy phép mã nguồn mở trên GitHub",
  },
  join: "Tham gia",
  joinTipStart: "Mời bạn tham gia",
  joinTipEnd: "đội tại Superbot",
  invalid: "Liên kết đã hết hạn",
  explore: "Khám phá Superbot",
